...
func convertPaymentDOToEntity(payment *ent.Payment) *entity.PaymentEntity {
	return &entity.PaymentEntity{
		...
		ChannelInfo: entity.PaymentChannelInfo{
			...
			Platform:      enum.ParseWechatOpenIDPlatform(payment.Platform.String()),
		...
		SubscriptionStatus: enum.ParseSubscriptionStatus(string(payment.SubscriptionStatus)),
		Interval:           enum.ParseSubscriptionInterval(string(payment.Interval)),
