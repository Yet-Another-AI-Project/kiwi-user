...
func (rc *RoleCreate) SetApplicationID(u uuid.UUID) *RoleCreate {
	rc.mutation.SetApplicationID(u)
	return rc
}
...
func (rc *RoleCreate) AddScopeIDs(ids ...uuid.UUID) *RoleCreate {
	rc.mutation.AddScopeIDs(ids...)
	return rc
}

// AddScopes adds the "scopes" edges to the Scope entity.
func (rc *RoleCreate) AddScopes(s ...*Scope) *RoleCreate {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return rc.AddScopeIDs(ids...)
}
...
func (rc *RoleCreate) check() error {
	...
	if _, ok := rc.mutation.ApplicationID(); !ok {
		return &ValidationError{Name: "application_id", err: errors.New(`ent: missing required field "Role.application_id"`)}
	}
	...
	if len(rc.mutation.ApplicationIDs()) == 0 {
		return &ValidationError{Name: "application", err: errors.New(`ent: missing required edge "Role.application"`)}
	}
	return nil
}
...
func (rc *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if nodes := rc.mutation.ScopesIDs(); len(nodes) > 0 {
